...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11646 = c;
var G__11646__$1 = (((G__11646 == null))?null:G__11646.prototype);
if((G__11646__$1 == null)){
return null;
} else {
return G__11646__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11651 = c;
var G__11651__$1 = (((G__11651 == null))?null:G__11651.prototype);
if((G__11651__$1 == null)){
return null;
} else {
return G__11651__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__11661 = c;
var G__11661__$1 = (((G__11661 == null))?null:G__11661.constructor);
if((G__11661__$1 == null)){
return null;
} else {
return G__11661__$1.displayName;
}
})();
...
var G__11662 = c;
var G__11662__$1 = (((G__11662 == null))?null:G__11662.constructor);
if((G__11662__$1 == null)){
return null;
} else {
return G__11662__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__11663 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11664 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11664);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11663);
}});
...
var c = this;
var G__11703_11757 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__11703_11757 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11703_11757);
}
...
var renders_11759 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11760 = cljs.core.first(cljs.core.vals(renders_11759));
...
if((cljs.core.count(renders_11759) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11759))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11760)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11760], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__11738 = o;
reagent.impl.component.goog$module$goog$object.set(G__11738,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__11739 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11740 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11740);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11739);
}});
...
var vec__11741 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11741,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11741,(1),null);
...
var G__11744 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__11744 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__11744);
}
});
}),[]);
