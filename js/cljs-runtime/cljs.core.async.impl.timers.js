...
var i_13909 = (self__.level + (1));
while(true){
if((i_13909 <= (new_level + (1)))){
(update[i_13909] = self__.header);

var G__13916 = (i_13909 + (1));
i_13909 = G__13916;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_13927 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13927[i]));
} else {
x__$2.forward.push((((i < links_13927.length))?(links_13927[i]):null));
}

if((i < links_13927.length)){
(links_13927[i] = x__$2);
} else {
links_13927.push(x__$2);
}
...
var i_13939 = (0);
while(true){
if((i_13939 <= self__.level)){
var links_13940 = (update[i_13939]).forward;
if((x__$1 === (((i_13939 < links_13940.length))?(links_13940[i_13939]):null))){
(links_13940[i_13939] = (x__$1.forward[i_13939]));

var G__13942 = (i_13939 + (1));
i_13939 = G__13942;
continue;
} else {
